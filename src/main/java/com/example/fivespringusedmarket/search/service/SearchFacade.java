...
public class SearchFacade {
     ...
     * 비로그인 사용자인 경우 null을 전달합니다.</p>
     */
    public ProductPageResponse searchProductsV3(Long memberId, String keyword, String category, String status, String sort, Pageable pageable)
    {

        Member member = findMemberOrNull(memberId);

        return searchService.searchProductsV3(
                member,
                keyword,
                category,
                status,
